                ...
                .map(|(tool_idx, table_tool)| match table_tool {
                    ...
                    _ => Btn::with_variant(
                        ...
                        vec![match table_tool {
                            ...
                            TableTool::Pen(..) => fa::i("fa-pen"),
                            TableTool::Shape(..) => fa::i("fa-shapes"),
                            TableTool::Eraser(..) => fa::i("fa-eraser"),
                            TableTool::Character(..) => fa::i("fa-users"),
                            TableTool::Boxblock(..) => fa::i("fa-cube"),
